...
# /* ── Kill the keyboard_double_arrow_right collapse icon ── */
# [data-testid="stSidebar"] [data-testid="stSidebarCollapseButton"],
# [data-testid="stSidebarCollapseButton"],
# [data-testid="collapsedControl"],
# button[kind="header"],
# [data-testid="stSidebar"] button svg,
# [data-testid="stSidebar"] .stDecoration,
# [data-testid="stSidebar"] span[data-baseweb="icon"],
...
# /* ══════════════════════════════════════
#    FILE UPLOADER — zero outer border
# ══════════════════════════════════════ */

# /* Strip ALL borders/backgrounds from every wrapper layer */
# .stFileUploader,
# .stFileUploader > div,
...
# /* The section Streamlit wraps around the dropzone */
# [data-testid="stFileUploader"] section[data-testid="stFileUploaderDropzone"],
# [data-testid="stFileUploaderDropzone"] {
#     background: var(--white) !important;
#     background-color: var(--white) !important;
#     border: 1.5px dashed rgba(26,23,20,0.16) !important;
...
# /* Everything inside the dropzone */
...
#     color: var(--ink4) !important;
#     fill: var(--ink4) !important;
# }

# /* Browse files button — restore its own border */
# [data-testid="stFileUploaderDropzone"] button {
#     background: var(--paper2) !important;
#     background-color: var(--paper2) !important;
#     border: 1px solid rgba(26,23,20,0.14) !important;
...
# }
# [data-testid="stFileUploaderFile"] * { color: var(--ink2) !important; background: transparent !important; }
...
# .rule-title { font-weight: 600; font-size: 0.855rem; color: var(--ink); line-height: 1.3; }
# .rule-sub { font-size: 0.77rem; color: var(--ink3); margin-top: 3px; line-height: 1.5; }
...
# /* ── Remove Streamlit default element padding ── */
# .element-container { margin-bottom: 0 !important; }
# div[data-testid="stVerticalBlock"] > div.element-container { margin-bottom: 4px !important; }

# /* ── Streamlit header/top toolbar ── */
# [data-testid="stHeader"] {
...
# /* ── Remove sidebar arrow/icon artifacts ── */
...
/* ── Hide Streamlit's native header bar entirely ── */
[data-testid="stHeader"],
[data-testid="stToolbar"],
[data-testid="stDecoration"],
...
/* Remove the top padding Streamlit adds to account for the header */
.main .block-container {
